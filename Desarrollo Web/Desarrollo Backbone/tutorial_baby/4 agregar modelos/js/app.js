  ...
  // -------- View --------
    ...
    var LibraryView = Backbone.View.extend({
        ...
        initialize:function(){
            ...
            this.collection.on("add", this.renderBook, this); //actualiza la vista cada agregado.
        },
        ...
        addBook: function(e){
          ...
          var formData = {}; //ojo, no recorre en profundidad, solo el primer nivel
          //recolecta indfo de los campos
          $( '#addBook div' ).children( 'input' ).each( function( i, el ) {
                if( $( el ).val() != "" ){
                  formData[ el.id ] = $( el ).val();
                }
            });
          var_books.push(formData); //agrega nuevo libro
