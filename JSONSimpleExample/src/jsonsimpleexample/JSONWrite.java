...
public class JSONWrite {  
    ...
    */
    ...
    private static JSONArray GenerarPredicados(){
        ...
        parametros.add(2); parametros.add(-1); parametros.add(1); parametros.add(2);
        ...
        parametros.add(1); parametros.add(2); parametros.add(2); parametros.add(3);
        parametros.add(1); parametros.add(2); parametros.add(2); parametros.add(3);
        ...
        parametros  = new ArrayList<Integer> ();
        parametros.add(1); parametros.add(-1);
